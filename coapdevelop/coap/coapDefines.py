...
DFLT_ACK_TIMEOUT                       = 3   # in s. MODIFICAT 20
DFLT_ACK_RANDOM_FACTOR                 = 1.5  # ACK timeout in [DFLT_ACK_TIMEOUT..DFLT_ACK_TIMEOUT*DFLT_ACK_RANDOM_FACTOR]
DFLT_MAX_RETRANSMIT                    = 1   # max number of retransmissions for NON MODIFICAT 5
...
DFLT_RESPONSE_TIMEOUT                  = 60   #  delay for app-level response MODIFICAT
